...
class CarreraAsignaturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carrera_asignatura" do
    assert_difference('CarreraAsignatura.count') do
      post carrera_asignaturas_url, params: { carrera_asignatura: { carrera_id: @carrera_asignatura.carrera_id, asignatura_id: @carrera_asignatura.asignatura_id } }, as: :json
    end
  ...
  test "should update carrera_asignatura" do
    patch carrera_asignatura_url(@carrera_asignatura), params: { carrera_asignatura: { carrera_id: @carrera_asignatura.carrera_id, asignatura_id: @carrera_asignatura.asignatura_id } }, as: :json
    assert_response 200
  end
